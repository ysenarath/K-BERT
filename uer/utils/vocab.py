...
from uer.utils.constants import UNK_ID


def count_line(corpus_path: Path | str) -> int:
    count = 0
        ...
        with open(vocab_path, mode="r", encoding="utf-8") as reader:
            for index, line in enumerate(reader):
                try:
                    ...
                    if not is_quiet:
                        print(f"Vocabulary file line {index + 1} has bad format token")
